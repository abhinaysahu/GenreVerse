    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-slate-50 to-white dark:from-black dark:to-slate-900">
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="mx-auto max-w-md rounded-xl glass p-6">
          <h1 className="text-2xl font-bold">Sign in to GenreVerse</h1>
          <p className="mt-2 text-sm text-foreground/70">Access your dashboard and saved analyses.</p>
          ...
          <form className="mt-6 flex flex-col gap-4" onSubmit={submit}>
            ...
            <div className="flex items-center gap-3">
              <button className="rounded-md bg-violet-600 px-4 py-2 text-sm font-semibold text-white">Sign in</button>
              <a href="/register" className="text-sm text-foreground/70 hover:underline">Create account</a>
            </div>
